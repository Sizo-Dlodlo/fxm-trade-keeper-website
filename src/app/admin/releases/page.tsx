    ...
    <div className="max-w-container-max mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-surface-container border border-surface-stroke rounded-xl p-6">
          <div className="font-headline-md text-2xl text-on-surface font-bold mb-1">3</div>
          <div className="font-body-md text-body-md text-text-dimmed">Total Releases</div>
        </div>
        <div className="bg-surface-container border border-surface-stroke rounded-xl p-6">
          <div className="font-headline-md text-2xl text-on-surface font-bold mb-1">v2.0.0</div>
          <div className="font-body-md text-body-md text-text-dimmed">Latest Stable</div>
        </div>
        <div className="bg-surface-container border border-surface-stroke rounded-xl p-6">
          <div className="font-headline-md text-2xl text-on-surface font-bold mb-1">12,025</div>
          <div className="font-body-md text-body-md text-text-dimmed">Total Downloads</div>
        </div>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-surface-stroke/50">
                ...
                <th className="text-left px-6 py-4 font-label-caps text-label-caps text-on-surface-variant uppercase">Downloads</th>
          ...
          <div className="relative bg-surface-container border border-surface-stroke rounded-xl p-8 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <select className="w-full bg-surface-dim border border-surface-stroke text-on-surface rounded-lg px-4 py-3 font-body-md text-body-md focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary">
              ...
              <div className="flex gap-4 justify-end">
                ...
                <button
                  type="submit"
                  className="bg-primary text-on-primary px-6 py-3 rounded-lg hover:brightness-110 transition-all font-body-md text-body-md font-medium"
                >
                  Publish Release
                </button>
              </div>
